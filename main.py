    ...
    if args.mode == "train":
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % 10 == 0:
                ...
                samples = flow_matcher.sample(sample_cond, num_steps=50, cfg_scale=4.0)
        ...
        print("Generating unwarped samples...")
        samples = flow_matcher.sample(condition, cfg_scale=4.0)
